...
*/
/*收單-紅利 Refund處理*/
public class BilO102 extends BilOBase {
 
 
 public BilO102(AuthTxnGate pGate, AuthGlobalParm pGlobalParm, TableAccess pTableAccess, String sPTxIndicator) throws Exception{
