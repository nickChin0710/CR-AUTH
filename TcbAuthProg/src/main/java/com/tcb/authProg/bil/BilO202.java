...
/*收單-分期付款 Refund 處理程式*/
public class BilO202 extends BilOBase {
 ...
 public BilO202(AuthTxnGate pGate, AuthGlobalParm pGlobalParm, TableAccess pTableAccess, String sPTxIndicator) throws Exception{
