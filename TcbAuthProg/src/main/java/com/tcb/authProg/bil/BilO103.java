...
/*收單-紅利 Refund處理*/
public class BilO103 extends BilOBase {


 public BilO103(AuthTxnGate pGate, AuthGlobalParm pGlobalParm, TableAccess pTableAccess, String sPTxIndicator) throws Exception{
  ...
  */
  ...
  tempX08 = String.format("%08d", hPointRede * -1);
  gRedeemTxData.setValue1(tempX08);
  
  long tempLong = (long) (hBpcdNetTtlBp - hPointRede);
