 ...
 * ----------  --------  ----------  -----------------------------------------*
 * 2017/07/01  V1.00.00  Edson       收單-分期付款 Refund 處理程式                 *
...
/*收單-分期付款 Refund 處理程式*/
public class BilO203 extends BilOBase {


// **************************************************************************
 public BilO203(AuthTxnGate pGate, AuthGlobalParm pGlobalParm, TableAccess pTableAccess, String sPTxIndicator) throws Exception {
	 progname = "收單-分期付款 Refund 處理程式  106/07/01 V1.00.00";
  ...
  if (hRespCd.equals("00")) {
	  gTableAccess.updateBilInstallLog(this);
  }
