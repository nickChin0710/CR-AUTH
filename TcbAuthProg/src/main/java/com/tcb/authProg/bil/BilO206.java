...
/*收單-分期付款 Refund 處理程式*/
public class BilO206 extends BilOBase {


// **************************************************************************
 public BilO206(AuthTxnGate pGate, AuthGlobalParm pGlobalParm, TableAccess pTableAccess, String sPTxIndicator) throws Exception {
  ...
  if (hRespCd.equals("00")) {
	  gTableAccess.updateBilInstalLog4(this);
  }
